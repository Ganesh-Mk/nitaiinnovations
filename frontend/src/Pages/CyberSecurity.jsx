...
function CyberSecurity() {
  ...
  return (
    <>
      ...
      >
        <Typography variant="h4" color="#0959AA" sx={{ textAlign: "left" }}>
        ...
        >
          ...
          burden of on-premise systems but also offers unparalleled security and
          dependability.
        </Typography>
        <Typography
          variant="h4"
        ...
        >
          Our penetration testing reports provide clear and actionable insights
          into identified vulnerabilities, along with prioritized
          recommendations for remediation. We believe in transparency and
          clarity, ensuring you have the information you need to strengthen your
        ...
        >
          ...
          customizable penetration testing engagements tailored to your specific
          requirements and objectives. Our collaborative approach ensures that
          the testing aligns with your business goals and delivers maximum
          value.
        </Typography>
        <Typography
          variant="h4"
        ...
        >
          Our commitment to your security doesn’t end with the completion of the
          penetration testing engagement. We offer post-testing support and
          monitoring services to help you address identified vulnerabilities and
          maintain a robust security posture over time.We understand that every
          business is unique, which is why we offer customizable penetration
          testing engagements tailored to your specific requirements and
          objectives. Our collaborative approach ensures that the testing aligns
          with your business goals and delivers maximum value.
        </Typography>
        <Typography
          variant="h4"
          color="#0959AA"
        ...
        <div className="container">
          ...
          >
            ...
            manual testing. The skills and abilities brought to the table by an
            experienced penetration test team emulate those of the threat. While
            Automated Vulnerability Scanners and Exploitation Frameworks do have
            a place, they are severely limited by the signatures or modules
          ...
          >
            ...
            <br />
            Our SaaS platform’s rich Pen Test Dashboard is under development and
            be made available soon in order to give access to our Penetration
            testing as a Service to the timelines, analytics, prioritised
            findings, and test progress for 24/7.
          </Typography>
          <Typography
            variant="h4"
            color="#0959AA"
          ...
          >
            ...
            >
              <ListItem>
                Versatility: <br /> Run pen tests for every need and asset type
                at the testing intensity you desire.
              </ListItem>
              <ListItem>
                IMPACT: <br />
                Count on pentester talent with the skills and experience needed
                for best results.
              </ListItem>
              <ListItem>
                SPEED: <br />
          ...
          >
            ...
            >
              <ListItem>
                ...
                (Buy & Set Up Online!)Test web applications, whether cloud-based
                or on-premises, of any complexity.
              </ListItem>
              <ListItem>
                Network Pen Test: <br />
              ...
              <ListItem>
                ...
                Find cyber-physical vulnerabilities unique to connected devices,
                from pacemakers to planes.
              </ListItem>
              <ListItem>
                Social Engineering Pen Test: <br />
                Run a specialised test to assess how your organisation responds
                to common social engineering threats.
              </ListItem>
            </List>
          </Typography>
        </div>
